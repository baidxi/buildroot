...
cp board/bingpi/m2/kernel.its "${BINARIES_DIR}"
cd "${BINARIES_DIR}"
...
support/scripts/genimage.sh ${1} -c board/bingpi/m2/genimage-sdcard.cfg
support/scripts/genimage.sh ${1} -c board/bingpi/m2/genimage-nand.cfg
