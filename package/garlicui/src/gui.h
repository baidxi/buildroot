...
#define NODE_TYPE_NETWORK_CONFIG_MENU	22
...
{
	short joy_keymap[GUI_KEYCODE_MAX];
	short kb_keymap[SDLK_LAST];
	bool ctrlkey;
	bool altkey;
...
{
	struct gui_menu_node_data base;
	int type;	/* ethernet / wireless */
	bool is_dhcp;
	union {
		struct {
			char ssid[128];
